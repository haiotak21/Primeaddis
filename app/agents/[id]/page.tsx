      ...
      <main className="container mx-auto px-4 py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:gap-12">
          ...
          <aside className="lg:col-span-1 xl:col-span-1">
            <div className="bg-card p-6 rounded-xl border border-border shadow-sm sticky top-28">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                {agent.email && (
                  <a
                    className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-primary text-primary-foreground text-base font-bold tracking-wide hover:bg-primary/90"
          ...
          <div className="lg:col-span-2 xl:col-span-3 flex flex-col gap-12">
            {/* About section */}
            <section>
              <h2 className="text-2xl font-bold tracking-tight pb-4 border-b border-border">
